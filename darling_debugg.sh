...
LLAMA_PATH="Qwen/Qwen2.5-0.5B-Instruct"
ATHENE_PATH="/home/scur1900/models/athene-rm-8b"
PARTITION_REWARD="/home/scur1900/darling_lukas/verl/verl/utils/reward_score/partition_reward_vllm_serve_modernbert.py"
...
\
    ...
    +reward_model.lambda_rm_rescale=0 \
