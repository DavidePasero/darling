...
def get_custom_reward_fn(config, diversity=False):
    import importlib.util
    import sys
    if diversity:
        reward_fn_config = config.reward_model.get("custom_diversity_function", {})
    else:
...
class TaskRunner:
    def run(self, config):
        ...
        diversity_reward_fn = load_reward_manager(config, tokenizer, num_examine=0, diversity=True, **config.reward_model.get("reward_kwargs", {}))
        val_reward_fn = load_reward_manager(config, tokenizer, num_examine=1)
        val_diversity_reward_fn = load_reward_manager(config, tokenizer, num_examine=1, diversity=True)
        ...
        trainer = RayPPOTrainer(
            ...
            reward_fn=reward_fn,
            diversity_reward_fn=diversity_reward_fn,
            val_reward_fn=val_reward_fn,
            val_diversity_reward_fn=val_diversity_reward_fn,
